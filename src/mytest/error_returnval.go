...
func main() {
    ...
    ret1, err1 := MySqrt(-1)
    if err1 != nil {
        fmt.Print("Error! Return values are: ", ret1, err1)
    } else {
        fmt.Print("It's ok! Return values are: ", ret1, err1)
    }

    fmt.Print("Second example with 5: ")
    //you could alse write it like this
...
func MySqrt2(f float64) (ret float64, err error){
    ...
    //automatically return the named return varibales ret and err
    return
}
